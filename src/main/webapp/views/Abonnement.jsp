...
<s:textfield name="idAbonement" label="ID AB"></s:textfield>
...
<s:select  id="typeAb" list="typeAB" name="type" label ="Type_AB" onchange="getSubForm(this.value)"></s:select>
...
<s:submit value="Save"></s:submit>
   ...
   <div class="cadre">
    <table class="table1">
      ...
      <tr>
        <td><s:property value="idAbonement"/></td>
